...
# Load the dataset
dataset_dirs = "/share/project/lxh/datasets/tf_datasets/fmb/0.0.1"
...
base_output_dir = "/share/project/yuqi.wang/datasets/processed_data/oxembodiment/fmb"
...
for episode in tqdm(ds_all_dict, desc="Processing episodes", unit="episode"):
    ...
    for i, step in tqdm(enumerate(episode["steps"]), desc=f"Processing episode {name}", total=len(episode["steps"]), unit="step"):
        ...
        image = observation["image_side_1"]
