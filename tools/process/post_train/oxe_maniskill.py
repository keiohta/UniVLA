...
# Load the dataset
dataset_dirs = "/share/project/lxh/datasets/tf_datasets/maniskill_dataset_converted_externally_to_rlds"
...
base_output_dir = "/share/project/yuqi.wang/datasets/processed_data/oxembodiment/maniskill"
...
for episode in tqdm(ds_all_dict, desc="Processing episodes", unit="episode"):
    ...
    for i, step in tqdm(enumerate(episode["steps"]), desc=f"Processing episode {name}", total=len(episode["steps"]), unit="step"):
        ...
        gripper_image.save(gripper_filename)
